...
torch.save(model.state_dict(), model_loc + '/Models/FRNN_NS_Block_'+field+'_'+run_id + '.pth')
wandb.save(model_loc + '/Models/FRNN_NS_Block_'+field+'_'+run_id + '.pth')
