...
FNO 2d time with NS Block - Data contains Blocks with different sizes - parameterised
by different lengths and widths. 

"""
# %%
import wandb
configuration = {"Case": 'NS Block',
                 "Field": 'P',
                 "Type": '2D Time',
                 "Epochs": 500,
                 "Batch Size":20,
...
# %%
data =  np.load(data_loc + '/Data/NS_Block.npz')
...
torch.save(model.state_dict(), model_loc + '/Models/FNO_NS_block_'+field+'_'+run_id + '.pth')
wandb.save(model_loc + '/Models/FNO_NS_block_'+field+'_'+run_id + '.pth')
