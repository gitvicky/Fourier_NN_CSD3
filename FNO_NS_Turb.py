...
FNO 2d time with NS Cylinder - Vortex Shedding - Data contains different Reynolds number ranging from 40 to 400.
Obtained by changing the Kinematic Viscosity. 

"""
# %%
import wandb
configuration = {"Case": 'NS Turbulence',
                 "Field": 'V',
                 "Type": '2D Time',
                 "Epochs": 500,
                 "Batch Size":20,
...
torch.save(model.state_dict(), model_loc + '/Models/FNO_NS_turb_'+field+'_'+run_id + '.pth')
wandb.save(model_loc + '/Models/FNO_NS_turb_'+field+'_'+run_id + '.pth')
