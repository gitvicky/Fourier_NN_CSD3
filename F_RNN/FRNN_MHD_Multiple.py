...
wandb.save('FRNN_MHD_Multiple.py')
...
torch.save(model.state_dict(), model_loc + '/Models/FRNN_MHD_Multiple_'+run_id + '.pth')
wandb.save(model_loc + '/Models/FRNN_MHD_Multiple_'+run_id + '.pth')
