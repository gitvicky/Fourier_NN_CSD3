...
wandb.save('FRNN_NS_Block_Multiple.py')
...
torch.save(model.state_dict(), model_loc + '/Models/FRNN_NS_block_UVP_'+run_id + '.pth')
wandb.save(model_loc + '/Models/FRNN_NS_block_UVP_'+run_id + '.pth')
