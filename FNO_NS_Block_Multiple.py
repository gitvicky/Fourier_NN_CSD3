...
# %%
import wandb
configuration = {"Case": 'NS Block - UVP',
                 "Type": '2D Time',
                 "Epochs": 500,
                 "Batch Size": 20,
                 "Optimizer": 'Adam',
...
wandb.save('FNO_NS_Block_Multiple.py')
...
torch.save(model.state_dict(), model_loc + '/Models/FNO_NS_block_UVP_'+run_id + '.pth')
wandb.save(model_loc + '/Models/FNO_NS_block_UVP_'+run_id + '.pth')
